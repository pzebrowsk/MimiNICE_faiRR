...
optimize_NICE(m, sum, revenue_recycle = false, active_controls ="tax", global_stop_time = 5, local_stop_time = 1, save_file_path = save_results_path)
# optimize_NICE(m, sum, revenue_recycle = true, active_controls ="tax", global_stop_time = 5, local_stop_time = 1, save_file_path = save_results_path)